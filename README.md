...
|Language|Framework & Library|Writing CSS|CSS Preprocessors|
|:-:|:-:|:-:|:-:|
...
|Module Bundlers & Compiler|Package Managers|VSC(Version Control Systems)|VSC Hosting|
|:-:|:-:|:-:|:-:|
...
|Serverless (BaaS)|Linter & Formatters|Collaborative Software|
|:-:|:-:|:-:|
